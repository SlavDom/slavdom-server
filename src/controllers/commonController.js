...
var CommonController = (function () {
    ...
    CommonController.mailSender = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var from, message, theme, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mailer_1.sendMail(from, theme, message)];
                    case 1:
                        result = _a.sent();
                        logger_1.logInfo("Mail is sent!");
