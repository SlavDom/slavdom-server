...
var UserController = (function () {
    ...
    UserController.prototype.saveUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordDigest, username, email, timezone, user;
            return __generator(this, function (_a) {
                passwordDigest = bcrypt.hashSync(req.body.password, 10);
                username = req.body.username.toLowerCase();
                email = req.body.email.toLowerCase();
                timezone = req.body.timezone;
                user = { username: username, passwordDigest: passwordDigest, timezone: timezone, email: email };
    ...
    UserController.prototype.ajaxCheck = function (req, res) {
